...
int main(){
    ...
    try{
        ...
        for (int i = 0; i < num_runs; i++) {
            // helpers::process_memory start_mem_usage = helpers::get_current_memory_usage();
            ...
            inference_duration = end - start; // Convert to milliseconds
        ...
        std::cout << "\n--- Inference Metrics over 100 runs ---" << std::endl;
